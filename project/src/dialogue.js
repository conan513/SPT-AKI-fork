...
class Callbacks
{
    constructor()
    {
        ...
        router_f.router.addStaticRoute("/client/friend/list", this.getFriendList.bind());
        router_f.router.addStaticRoute("/client/chatServer/list", this.getChatServerList.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/list", this.getMailDialogList.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/view", this.getMailDialogView.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/info", this.getMailDialogInfo.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/remove", this.removeDialog.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/pin", this.pinDialog.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/unpin", this.unpinDialog.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/read", this.setRead.bind());
        router_f.router.addStaticRoute("/client/mail/dialog/getAllAttachments", this.getAllAttachments.bind());
        router_f.router.addStaticRoute("/client/friend/request/list/outbox", this.listOutbox.bind());
        router_f.router.addStaticRoute("/client/friend/request/list/inbox", this.listInbox.bind());
    }
