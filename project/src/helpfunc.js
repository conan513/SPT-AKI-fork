...
function addDogtag(profile, sessionID)
{
    let dogtagItem = {
...
function generateInventoryID(profile)
{
...
function removeSecureContainer(profile)
{
...
* */
function getSize(itemtpl, itemID, InventoryItem)
...
module.exports.removeSecureContainer = removeSecureContainer;
...
module.exports.appendErrorToOutput = appendErrorToOutput;
